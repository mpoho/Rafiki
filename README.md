# Rafiki — Outils voix (`rafiki_outils`)
...
Le dossier **`rafiki_outils`** contient le **module voix local** de Rafiki : les briques logicielles qui permettent au robot de **parler** et **d'écouter**, sans dépendre d'Internet pour la voix.
...
## 2. Structure du dossier `rafiki_outils`

```
rafiki_outils/
└── Rafiki/                    ← Module Python principal (dépôt Git)
    ...
    ├── README.md              ← Description générale du projet Rafiki
...
```powershell
cd C:\Rafiki\rafiki_outils\Rafiki
...
| Doc technique voix | `Rafiki/README_VOICE.md` |
